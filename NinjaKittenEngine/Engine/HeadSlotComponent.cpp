...
Engine::HeadSlotComponent::HeadSlotComponent(System* pSystem, GameObject* pGameObject, const char* file)
...
void Engine::HeadSlotComponent::Render(Engine::System* pSystem)
{
